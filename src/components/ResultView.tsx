            ...
            {currentStep === 'frame' && (
              ...
              >
                  ...
                  {frames.map(([id, cfg]) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className={`flex flex-col p-3 rounded-2xl text-left group relative bg-white cursor-pointer ${
                          isSelected
                ...
                <div className="pt-4 flex items-center justify-between gap-3">
                  <motion.button
                    id="frame-step-prev-btn"
                    onClick={onRetake}
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.94 }}
                    transition={{ type: 'spring', stiffness: 400, damping: 25 }}
                    className="px-6 py-3.5 rounded-full bg-white hover:bg-[#1A1A1A] hover:text-white text-[#1A1A1A] inline-flex items-center justify-center shadow-xs hover:shadow-md cursor-pointer group"
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.94 }}
                    transition={{ type: 'spring', stiffness: 400, damping: 25 }}
                    className="px-7 py-3.5 rounded-full bg-[#1A1A1A] hover:bg-black text-white inline-flex items-center justify-center shadow-md hover:shadow-xl cursor-pointer group"
                  ...
                  {filters.map(([id, cfg]) => {
                    ...
                    return (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        transition={{ type: 'spring', stiffness: 400, damping: 25 }}
                        className={`flex flex-col rounded-xl text-left overflow-hidden group relative bg-white cursor-pointer ${
                          isSelected
                            ? 'ring-2 ring-[#1A1A1A] shadow-md'
                            : 'shadow-xs hover:shadow-md'
                        }`}
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    transition={{ type: 'spring', stiffness: 400, damping: 25 }}
                    className={`flex flex-col items-start p-5 sm:p-6 rounded-2xl text-left bg-white cursor-pointer ${
                      layout === 'strip-4'
                        ? 'ring-2 ring-[#1A1A1A] shadow-md'
                        : 'shadow-xs hover:shadow-md'
                    }`}
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    transition={{ type: 'spring', stiffness: 400, damping: 25 }}
                    className="flex items-center gap-3.5 p-4 sm:p-5 rounded-2xl bg-[#1A1A1A] hover:bg-black text-white text-left shadow-md hover:shadow-xl group cursor-pointer"
                  >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    transition={{ type: 'spring', stiffness: 400, damping: 25 }}
                    className="flex items-center gap-3.5 p-4 sm:p-5 rounded-2xl bg-white hover:bg-[#1A1A1A] hover:text-white text-[#1A1A1A] text-left shadow-xs hover:shadow-md group cursor-pointer"
                  >
                ...
                <div className="pt-4 flex items-center justify-between gap-3">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.94 }}
                    transition={{ type: 'spring', stiffness: 400, damping: 25 }}
                    className="px-6 py-3.5 rounded-full bg-[#1A1A1A] hover:bg-black text-white inline-flex items-center gap-2 shadow-md hover:shadow-xl cursor-pointer group text-xs sm:text-sm font-bold uppercase tracking-wider font-mono-stamp"
                  >
                    <span>Gallery</span>
